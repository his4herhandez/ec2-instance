...
class CreateClipPaymentTransactionsTable extends Migration
{
    public function up()
    {
        Capsule::schema()->create('clip_payment_transactions', function (Blueprint $table) {
    ...
    {
        Capsule::schema()->dropIfExists('clip_payment_transactions');
    }
}